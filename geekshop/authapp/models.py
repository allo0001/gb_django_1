...
class ShopUserProfile(models.Model):
    ...
    tagline = models.CharField(max_length=128, blank=True, null=True,verbose_name='Теги')
    about_me = models.TextField(blank=True, null=True, max_length=512, verbose_name='Обо мне')
